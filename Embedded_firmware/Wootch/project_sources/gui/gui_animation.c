 ...
 * @param y_new Y position of the backgroun (how far it goes)
 */
void gui_anim_bg(uint32_t delay, lv_color_t color, int32_t y_new)
{
    ...
    if (y_new != GUI_BG_NORMAL && y_new == y_act && act_color.full == color.full)
        return;
...
/**
 * @brief Animate all object out of the screen
 * 
...
/**
 * @brief Animate an object Into the screen
 * 
...
/**
 * @brief Animate background color
 * 
 * @param a LV animation
 * @param v LV animation value
 */

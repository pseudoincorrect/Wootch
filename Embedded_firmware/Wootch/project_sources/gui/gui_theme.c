...
/**
 * @brief Initiate the theme of the GUI
 */
static void basic_init(void)
{
    ...
    lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT,
                              GUI_BG_1_BORDER);
    lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, GUI_FG_1);

    lv_style_init(&style_title);
    lv_style_set_text_color(&style_title, LV_STATE_DEFAULT, GUI_FG_1);
    lv_style_set_text_font(&style_title, LV_STATE_DEFAULT, theme.font_subtitle);

    lv_style_init(&style_label_white);
    lv_style_set_text_color(&style_label_white, LV_STATE_DEFAULT,
                            GUI_FG_1);

    lv_style_init(&style_btn);
    lv_style_set_radius(&style_btn, LV_STATE_DEFAULT, 10);
    lv_style_set_bg_opa(&style_btn, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, GUI_BLUE);
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED,
                          lv_color_darken(GUI_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, GUI_FG_1);
    lv_style_set_value_color(&style_btn, LV_STATE_DEFAULT, GUI_FG_1);
    ...
    lv_style_set_border_color(&style_btn_border, LV_STATE_DEFAULT,
                              GUI_FG_1);
    ...
    lv_style_set_bg_color(&style_btn_border, LV_STATE_DEFAULT,
                          GUI_FG_1);
    lv_style_set_bg_color(&style_btn_border, LV_STATE_PRESSED,
                          GUI_FG_1);
    lv_style_set_text_color(&style_btn_border, LV_STATE_DEFAULT,
                            GUI_FG_1);
    lv_style_set_value_color(&style_btn_border, LV_STATE_DEFAULT,
                             GUI_FG_1);
    lv_style_set_transition_prop_3(&style_btn_border, LV_STATE_DEFAULT,
                                   LV_STYLE_BG_OPA);

    lv_style_init(&style_icon);
    lv_style_set_text_color(&style_icon, LV_STATE_DEFAULT, GUI_FG_1);
    ...
    lv_style_set_transition_prop_1(&style_icon, LV_STATE_DEFAULT,
                                   LV_STYLE_TRANSFORM_ZOOM);

    lv_style_init(&style_back);
    lv_style_set_value_color(&style_back, LV_STATE_DEFAULT, GUI_FG_1);
    lv_style_set_value_color(&style_back, LV_STATE_PRESSED,
                             GUI_FG_1_2);
    ...
    lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT,
                          GUI_FG_1_2);
    ...
    lv_style_set_bg_color(&style_list_btn, LV_STATE_DEFAULT, GUI_FG_1);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_PRESSED,
                          GUI_FG_1_2);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, GUI_FG_1);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED,
                          lv_color_darken(GUI_FG_1, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT,
                            GUI_BLUE);
    lv_style_set_text_color(&style_list_btn, LV_STATE_PRESSED,
                            lv_color_darken(GUI_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED,
                            GUI_FG_1);
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED,
                            GUI_FG_1);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT,
                               GUI_BLUE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_PRESSED,
                               lv_color_darken(GUI_BLUE, LV_OPA_20));
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED,
                               GUI_FG_1);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED,
                               GUI_FG_1);
    ...
    lv_style_set_text_line_space(&style_ddlist_list, LV_STATE_DEFAULT,
                                 LV_VER_RES / 25);
    lv_style_set_shadow_width(&style_ddlist_list, LV_STATE_DEFAULT,
                              LV_VER_RES / 20);
    lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT,
                              GUI_FG_1);

    lv_style_init(&style_ddlist_selected);
    lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT,
                          GUI_BLUE);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_PRESSED,
                          GUI_FG_1_2);
    lv_style_set_text_color(&style_ddlist_selected, LV_STATE_PRESSED,
                            lv_color_darken(GUI_FG_1, LV_OPA_20));

    lv_style_init(&style_sw_bg);
    lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT,
                          GUI_FG_1_2);
    lv_style_set_radius(&style_sw_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
    lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, GUI_BLUE);

    lv_style_init(&style_sw_indic);
    lv_style_set_bg_opa(&style_sw_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT, GUI_GREEN);

    lv_style_init(&style_sw_knob);
    lv_style_set_bg_opa(&style_sw_knob, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, GUI_FG_1);
    ...
    lv_style_set_bg_color(&style_slider_knob, LV_STATE_DEFAULT,
                          GUI_BLUE);
    lv_style_set_border_color(&style_slider_knob, LV_STATE_DEFAULT,
                              GUI_FG_1);
    ...
    lv_style_set_transition_prop_1(&style_slider_knob, LV_STATE_DEFAULT,
                                   LV_STYLE_PAD_BOTTOM);
    lv_style_set_transition_prop_2(&style_slider_knob, LV_STATE_DEFAULT,
                                   LV_STYLE_PAD_TOP);
    lv_style_set_transition_prop_3(&style_slider_knob, LV_STATE_DEFAULT,
                                   LV_STYLE_PAD_LEFT);
    lv_style_set_transition_prop_4(&style_slider_knob, LV_STATE_DEFAULT,
                                   LV_STYLE_PAD_RIGHT);

    lv_style_init(&style_arc_indic);
    lv_style_set_line_width(&style_arc_indic, LV_STATE_DEFAULT, 5);
    lv_style_set_line_color(&style_arc_indic, LV_STATE_DEFAULT,
                            GUI_FG_1);

    lv_style_init(&style_arc_bg);
    lv_style_set_value_color(&style_arc_bg, LV_STATE_DEFAULT,
                             GUI_FG_1);
 ...
 */
lv_theme_t *gui_theme_init(lv_color_t color_primary,
                           lv_color_t color_secondary, uint32_t flags,
...
/**
 * @brief Apply a theme to an object
 * 
 * @param obj object to apply the theme
...
static void theme_apply(lv_obj_t *obj, lv_theme_style_t name)
{
    ...
    case GUI_THEME_TITLE:
        lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
        list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
        _lv_style_list_add_style(list, &style_title);
        break;

    case GUI_THEME_LABEL_WHITE:
        lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
        list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);

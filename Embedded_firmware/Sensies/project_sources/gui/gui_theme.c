...
static void basic_init(void)
{
    ...
    lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, GUI_LIGHT);
    ...
    lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, GUI_BLUE);
    ...
    lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT,
                              GUI_GRAY);
    lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, GUI_BLUE);


    lv_style_init(&style_title);
    lv_style_set_text_color(&style_title, LV_STATE_DEFAULT, GUI_WHITE);
    ...
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, GUI_WHITE);
    lv_style_set_value_color(&style_btn, LV_STATE_DEFAULT, GUI_WHITE);
    ...
    lv_style_set_text_color(&style_icon, LV_STATE_DEFAULT, GUI_WHITE);
    ...
    lv_style_set_value_color(&style_back, LV_STATE_DEFAULT, GUI_WHITE);
    ...
    lv_style_set_bg_color(&style_list_btn, LV_STATE_DEFAULT, GUI_WHITE);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_PRESSED,
                          GUI_LIGHT_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, GUI_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED,
                          lv_color_darken(GUI_GRAY, LV_OPA_20));
    ...
    lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, GUI_WHITE);
